...
from advsce.proto_lib.modules.map.proto.map_lane_pb2 import Lane
from advsce.proto_lib.modules.map.proto.map_crosswalk_pb2 import Crosswalk
import sys, os, math, logging, json
from typing import Dict, Iterable, Mapping, Tuple, Union

from advsce.geometry import Vector, Segment, SLPoint, check_intersect, lerp, clamp, intersect_point
from advsce.utils import DictObj, Match, check_type

from advsce.map import MapParser, map_config
from .kdtree import KDTree, SegmentInfo
from .visualizer import MapVisualizerServer
import advsce.simulator as simulator
...
class Map:    
    ...
    def __init__(self, sim_type, map_name:str):
        ...
        # init lanes
        self.lanes: Mapping[str, Lane] = DictObj()
